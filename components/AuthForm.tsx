  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      if(type === "sign-up") {
        ...
        const userCredentials = await createUserWithEmailAndPassword(auth, email, password); // this is only authenticating user

        // now we will actually sign the user up in firestore db
